...
//     script.src = "https://maps.googleapis.com/maps/api/js?key=AIzaSyCmuVWpm0lkdNiq3wWZpEz0XYtDjmoN-wY&callback=initMap&libraries=places";
//     script.async = true;
...
//     return () => {
//       // Clean up script and map initialization
...
//       <div role="document" className='modalDialog'>
//         <div className="modalContent">
          
//           <div className="modalHeader">
//             <h5 className="modal-title modalTitle" id="specialOrderModalLabel">Place Special Order</h5>
//             <button type="button" className="close specialClose" data-dismiss="modal" aria-label="Close" onClick={closeModal}>
...
//                   <label htmlFor="customerName" className='specialLabels'>Customer Name</label>
//                   <input
//                     type="text"
...
//                 <div className="formGroup">
//                   <label htmlFor="customerEmail" className='specialLabels'>Customer Email</label>
//                   <input
//                     type="email"
//                     className="form-control formControl"
//                     id="customerEmail"
...
//                 <div className="formGroup">
//                 <label htmlFor="customerPhone" className='specialLabels'>Phone Number</label>
//                 <input
//                   type="tel"
//                   className="form-control formControl"
//                   id="customerPhone"
...
//                   name="orderDetails"
//                   rows="3"
//                   placeholder="Enter details of your special order"
...
//               <div className="formGroup">
//                 <label htmlFor="deliveryLocation" className='specialLabels'>Delivery Location</label>
//                 <button type="button" className="specialPin" onClick={showMap}>Pin Location</button>
//                 <div id="map"></div>
//                 <input
//                   type="text"
//                   className="form-control mt-2 formControl"
//                   id="deliveryLocation"
//                   name="deliveryLocation"
//                   placeholder="Pin your delivery location on the map"
...
//               <div className='specialCloseBtn'>
//                 <button type="submit" className="btn btn-primary" id='btnPrimary'>Submit</button>
//               </div>
//             </form>
//           </div>
//         </div>
