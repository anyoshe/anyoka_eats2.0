...
//           <p>Delivered At: {new Date(order.deliveredAt || order.updatedAt || order.createdAt).toLocaleString()}</p>
...
//               <li key={sub._id}>
//                 <strong>Shop:</strong> {sub.shop?.businessName || 'Unknown'}<br />
//                 <strong>Status:</strong> {sub.status}<br />
//                 <ul>
//                   {sub.items.map((item) => (
//                     <li key={item._id}>
//                       {item.product?.name} — Qty: {item.quantity} — KES {item.price}
//                     </li>
//                   ))}
//                 </ul>
