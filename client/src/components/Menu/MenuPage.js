...
//                         e.target.src = '/path/to/placeholder-image.jpg'; // Fallback if the image fails to load
//                       }}
//                     />
...
//                       <p className="categorySectionQuantity categorySectionP"><span>{product.quantity}</span>{product.unit}</p>
//                     </div>
